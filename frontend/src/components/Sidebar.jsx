...
export default function Sidebar({ open, onToggle }) {
  ...
  const navItems = [
    ...
    { icon: '📊', label: t.nav.analytics, active: false },
    { icon: '📦', label: t.nav.orders, active: false },
    { icon: '👥', label: t.nav.customers, active: false },
    { icon: '🛍️', label: t.nav.products, active: false },
    { icon: '⚙️', label: t.nav.settings, active: false },
  ]
